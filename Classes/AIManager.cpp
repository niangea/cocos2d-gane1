...
void AIManager::setAI(Enemy* enemy, Hero* hero)
{
	...
	auto opt = Sequence::create(
		...
		CallFunc::create(CC_CALLBACK_0(AIManager::attack2, this)),
		DelayTime::create(1.0f),
		CallFunc::create(CC_CALLBACK_0(AIManager::stand, this)),
		DelayTime::create(3.5f),
		CallFunc::create(CC_CALLBACK_0(AIManager::attack3, this)),
...
void AIManager::update(float delta)
{
	...
	else if (m_enemy_state == State::ATTACK2)
	{
		m_enemy->play(ATTACK2);
	}
	else if (m_enemy_state == State::ATTACK3)
	{
		m_enemy->play(ATTACK3);
	}
}
...
void AIManager::attack2() {

	m_enemy_state = State::ATTACK2;
}

void AIManager::attack3() {
	m_enemy_state = State::ATTACK3;
}
